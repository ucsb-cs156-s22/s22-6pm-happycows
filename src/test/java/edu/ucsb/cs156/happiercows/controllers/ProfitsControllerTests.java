...
public class ProfitsControllerTests extends ControllerTestCase {
  ...
  @WithMockUser(roles = { "USER" })
  @Test
  public void post_profits_post() throws Exception {
    UserCommons expectedUserCommons = UserCommons.builder().id(1).commonsId(2).userId(1).build();
    ...
    MvcResult response = mockMvc.perform(post("/api/profits/post?profit=100&timestamp=12&userCommonsId=1").with(csrf())).andDo(print()).andExpect(status().isOk()).andReturn();
  ...
  @WithMockUser(roles = { "USER" })
  @Test
  public void post_profits_post_nonexistent() throws Exception {
  ...
  @WithMockUser(roles = { "USER" })
  @Test
  public void delete_profits() throws Exception {
    UserCommons expectedUserCommons = UserCommons.builder().id(1).commonsId(2).userId(1).build();
    ...
    MvcResult response = mockMvc.perform(delete("/api/profits?id=42").with(csrf())).andExpect(status().isOk()).andReturn();
  ...
  @WithMockUser(roles = { "USER" })
  @Test
  public void delete_profits_other_user() throws Exception {
    UserCommons expectedUserCommons = UserCommons.builder().id(1).commonsId(2).userId(100).build();
    Profit p = Profit.builder().id(42).profit(100).timestamp(12).userCommons(expectedUserCommons).build();
  ...
  @WithMockUser(roles = { "USER" })
  @Test
  public void put_profits() throws Exception {
    UserCommons expectedUserCommons = UserCommons.builder().id(1).commonsId(2).userId(1).build();
    Profit p = Profit.builder().id(42).profit(100).timestamp(12).userCommons(expectedUserCommons).build();
    ...
    MvcResult response = mockMvc.perform(put("/api/profits?id=42").contentType(MediaType.APPLICATION_JSON).characterEncoding("utf-8").content(requestBody).with(csrf())).andExpect(status().isOk()).andReturn();
  ...
  @WithMockUser(roles = { "USER" })
  @Test
  public void put_profits_other_user() throws Exception {
    UserCommons expectedUserCommons = UserCommons.builder().id(1).commonsId(2).userId(100).build();
    Profit p = Profit.builder().id(42).profit(100).timestamp(12).userCommons(expectedUserCommons).build();
